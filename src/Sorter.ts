...
export function quicksort(arr: number[]): void {
   ...
   * @returns
   */
  const sort = (arr: number[], left: number, right: number): void => {
...
export function mergesort(arr: number[]): void {
   ...
   * @returns 
   */
  const mergeRecursive = (arr: number[], left: number, right: number): void => {
    if (left >= right) return;
   ...
   * @param right The rightmost index.
   */
  const merge = (arr: number[], middle: number, left: number, right: number): void => {
